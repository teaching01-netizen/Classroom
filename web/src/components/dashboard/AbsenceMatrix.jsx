...
export function AbsenceMatrix({ students, sessions }) {
      ...
      >
        ...
        <tbody>
          {students.map((student) => (
            <StudentRow key={student.studentId} student={student} sessions={sessions} />
          ))}
        </tbody>
      </table>
    </div>
...
function StudentRow({ student, sessions }) {
